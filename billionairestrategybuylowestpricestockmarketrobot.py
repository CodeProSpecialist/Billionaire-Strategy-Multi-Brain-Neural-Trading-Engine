...
# Scanner universe — restricted to the user's tech-focused watchlist
# (~70 names spanning semis, software, networking, IT services, and
# tech hardware). Kept as _SCANNER_SP500_UNIVERSE so every downstream
# reference (get_symbols_to_buy, backtests, ML pretraining fallback)
# picks it up without further edits.
_SCANNER_SP500_UNIVERSE = [
    'AAPL', 'ACN', 'ADBE', 'ADI', 'ADSK', 'AKAM', 'AMAT', 'AMD', 'ANET',
    'APH', 'AVGO', 'CDNS', 'CDW', 'CIEN', 'COHR', 'CRM', 'CRWD', 'CSCO',
    'CTSH', 'DDOG', 'DELL', 'FFIV', 'FICO', 'FSLR', 'FTNT', 'GDDY', 'GEN',
    'GLW', 'HPE', 'HPQ', 'IBM', 'INTC', 'INTU', 'IT', 'JBL', 'KEYS',
    'KLAC', 'LITE', 'LRCX', 'MCHP', 'MPWR', 'MSFT', 'MSI', 'MU', 'NOW',
    'NTAP', 'NVDA', 'NXPI', 'ON', 'ORCL', 'PANW', 'PLTR', 'PTC', 'Q',
    'QCOM', 'ROP', 'SMCI', 'SNDK', 'SNPS', 'STX', 'SWKS', 'TDY', 'TEL',
    'TER', 'TRMB', 'TXN', 'TYL', 'VRSN', 'WDAY', 'WDC', 'ZBRA',
]
_SCANNER_SP500_UNIVERSE_OLD_UNUSED = [
